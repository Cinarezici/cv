      ...
      <div className="fixed top-4 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-5xl z-50 flex justify-center pointer-events-none">
        <header className="flex items-center justify-between w-full h-16 px-4 md:px-6 border border-zinc-200/80 bg-white/70 backdrop-blur-xl rounded-full shadow-[0_8px_32px_-8px_rgba(0,0,0,0.08)] pointer-events-auto transition-all">
          ...
          <nav className="hidden md:flex gap-8 items-center text-[15px] font-bold text-zinc-500">
            ...
            <Link className="text-blue-600" href="/pricing">Pricing</Link>
              ...
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="bg-[#fafafa] border-b border-neutral-200 text-[14px]">
                    ...
                    <th className="p-4 font-extrabold text-blue-600 text-center bg-blue-50/30 w-[17.5%]">Professional</th>
                    <th className="p-4 font-extrabold text-purple-700 text-center w-[17.5%]">Lifetime</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-neutral-200 text-[14px]">
                  {comparisonFeatures.map((row) => (
                    <tr key={row.feature} className="hover:bg-zinc-50/50 transition-colors">
                      ...
                      <td className="p-4 text-center bg-blue-50/30">{renderCell(row.pro)}</td>
