        ...
        <div className="max-w-6xl mx-auto py-8 space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-zinc-500 dark:text-zinc-400 mt-1 text-sm">All your created CVs. Edit, share, or delete them.</p>
                </div>
                <Link
            ...
            {documents.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-24 border-2 border-dashed border-zinc-200 dark:border-white/10 rounded-2xl bg-white dark:bg-[#0f1525]">
                    ...
                    <h3 className="text-xl font-bold text-zinc-700 dark:text-zinc-200">No CVs yet</h3>
                    <p className="text-zinc-400 dark:text-zinc-500 text-sm mt-2 mb-6">Create your first CV using the CV Builder.</p>
                    <Link
                        href={isCVLimitReached ? "/upgrade" : "/builder/new"}
