...
import { Mail, Phone, MapPin, Linkedin as LinkedinIcon, Briefcase, User, Book, Palette, Type } from 'lucide-react';
...
export default function ResumeViewer({ data, initialAvatarUrl }: { data: any, initialAvatarUrl: string | null }) {
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center gap-8 lg:gap-10 w-full max-w-7xl mx-auto">
                ...
                <div className="w-full max-w-[380px] shrink-0 bg-white rounded-xl shadow-lg border border-zinc-200 p-6 lg:p-8 flex flex-col gap-6 print:hidden lg:sticky top-8">
                    <div className="flex flex-col sm:flex-row justify-between gap-4 border-b border-zinc-100 pb-4 items-center">
                        <h2 className="text-xl font-black text-zinc-900 tracking-tight">CV Dashboard</h2>
                        <button
                            onClick={handlePrint}
                        ...
                        {activeTab === 'content' ? (
                            <>
                                    ...
                                    <div className="flex items-center gap-4 sm:gap-5">
                                        {avatarUrl ? (
                                            ...
                                            <div className="w-16 h-16 sm:w-20 sm:h-20 aspect-square min-w-[64px] sm:min-w-[80px] min-h-[64px] sm:min-h-[80px] flex-none rounded-full border-2 border-zinc-300 bg-white flex items-center justify-center shadow-sm">
                                                <span className="text-xl sm:text-2xl text-zinc-400 font-bold">{name.charAt(0)}</span>
                                            </div>
                                        )}
                                        ...
                                        <div className="flex flex-col gap-2.5 flex-1">
                                            <label className="cursor-pointer border-2 border-indigo-200 bg-indigo-50/50 rounded-lg py-2 text-center hover:bg-indigo-100 hover:border-indigo-300 transition-all w-full select-none">
                                                <span className="text-sm font-bold text-indigo-700">Upload New Photo</span>
                                            ...
                                            <div className="flex items-center justify-between px-1">
                                                <label className="flex items-center gap-2 cursor-pointer select-none">
                                                    ...
                                                    />
                                                    <span className="text-[12px] sm:text-[13px] font-bold text-zinc-700">Display on CV</span>
                                                </label>
                                                {avatarUrl && (
                                                    <button
                                                        onClick={() => { setAvatarUrl(null); setShowPhoto(false); }}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">Display Name</label>
                                        <input
                                            type="text"
                                            value={name}
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">Email Address</label>
                                        <input
                                            type="text"
                                            value={email}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">Phone Number</label>
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">Location</label>
                                        <input
                                            type="text"
                                            value={location}
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">LinkedIn URL</label>
                                        <input
                                            type="text"
                                            value={linkedin}
                            ...
                            <div className="flex flex-col gap-6 w-full">
                                ...
                                <div className="flex flex-col gap-4 p-5 bg-zinc-50 rounded-xl border border-zinc-200 shadow-inner">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <div className="flex justify-between items-center">
                                            <span className="text-[12px] font-bold text-zinc-600">Primary Accent</span>
                                            <input
                                                type="color"
                                                value={accentColor}
                                        ...
                                        <div className="flex justify-between items-center">
                                            <span className="text-[12px] font-bold text-zinc-600">Sidebar Background</span>
                                            <input
                                                type="color"
                                                value={sidebarColor}
                                ...
                                <div className="flex flex-col gap-4 p-5 bg-zinc-50 rounded-xl border border-zinc-200 shadow-inner">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-[11px] font-black text-zinc-500 uppercase tracking-widest">Font Family</label>
                                        <select
                                            value={fontFamily}
                ...
                <div
                    ...
                    style={{ minHeight: '297mm', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact', fontFamily: fontFamily }}
                >
                    {/* Left Sidebar - Dark Theme */}
                    <aside className="w-[32%] text-zinc-300 p-8 flex flex-col shrink-0" style={{ backgroundColor: sidebarColor }}>
                        {/* Profile Picture */}
                        {showPhoto && avatarUrl ? (
                        ...
                        <div className="space-y-4 mb-10">
                            ...
                            {linkedin && (
                                <div className="flex items-center gap-3 text-[13px] mt-1 break-all">
                                    <LinkedinIcon className="w-4 h-4 shrink-0" style={{ color: accentColor }} />
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {data.skills.map((skill: string, i: number) => (
                                        <span key={i} className="bg-zinc-800 text-zinc-300 text-[11px] px-3 py-1 rounded-sm border border-zinc-700">
                                            {skill}
                                        </span>
                                    ))}
                                </div>
                    ...
                    <main className="flex-1 bg-white text-zinc-800 p-10 pt-12 flex flex-col">
                        ...
                        <header className="mb-10">
                            ...
                            {data.headline && (
                                <div className="mt-3 inline-block px-4 py-1.5 font-bold tracking-wide rounded text-sm uppercase" style={{ backgroundColor: `${accentColor}20`, color: accentColor }}>
                                    {data.headline}
                                </div>
                            )}
                        </header>
                        ...
                        {data.summary && (
                            <section className="mb-10">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <h2 className="text-lg font-bold text-zinc-900 uppercase tracking-widest">Profile</h2>
                                </div>
                        ...
                        {data.experience && data.experience.length > 0 && (
                            <section className="mb-10">
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <h2 className="text-lg font-bold text-zinc-900 uppercase tracking-widest">Experience</h2>
                                </div>
                                    ...
                                    {data.experience.map((exp: any, i: number) => (
                                        <div key={i} className="relative pl-4 border-l-2 border-zinc-200">
                                            ...
                                            <div className="flex flex-col sm:flex-row justify-between items-start mb-2">
                                                <div>
                                                    <h3 className="font-bold text-zinc-900 text-[16px]">{exp.title}</h3>
                                                ...
                                                <span className="text-[12px] font-bold px-2 py-1 rounded mt-1 sm:mt-0 whitespace-nowrap" style={{ backgroundColor: `${accentColor}1A`, color: accentColor }}>
                                            ...
                                            <ul className="mt-3 space-y-2">
                                                {exp.bullets?.map((bullet: string, j: number) => (
                                                    <li key={j} className="text-[13px] text-zinc-600 leading-relaxed pl-4 relative before:content-['■'] before:absolute before:left-0 before:top-[4px] before:text-[8px] before:text-zinc-300">
                                                        {bullet}
                                                    </li>
                                                ))}
                                            </ul>
                        ...
                        {data.education && data.education.length > 0 && (
                            <section>
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <h2 className="text-lg font-bold text-zinc-900 uppercase tracking-widest">Education</h2>
                                </div>

                                <div className="grid grid-cols-1 gap-4">
                                    {data.education.map((edu: any, i: number) => (
                                        <div key={i} className="bg-zinc-50 p-4 rounded-lg border border-zinc-100">
                                            <div className="flex justify-between items-start">
                                                <div>
                                                    <h3 className="font-bold text-zinc-900 text-[14px]">{edu.degree}</h3>
                                                    <p className="text-[13px] text-zinc-500 mt-1">{edu.school}</p>
                                                </div>
                                                <span className="text-[12px] font-semibold text-zinc-400">{edu.year}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
