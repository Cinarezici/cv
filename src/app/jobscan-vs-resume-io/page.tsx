            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/30 border border-blue-200/60 p-10 rounded-[32px] shadow-lg shadow-blue-900/5 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-zinc-600 font-medium leading-relaxed max-w-2xl mx-auto mb-10">
                  CVOptimizerAI bridges the gap brilliantly. You get the deep ATS parser insights of Jobscan with the aesthetic ease of Resume.io—supercharged by state-of-the-art AI that actually rewrites your resume contextually to land the interview.
                </p>
                ...
                <p className="mt-4 text-[13px] font-bold text-zinc-500">
                  Check your score in 30 seconds. No credit card required.
                </p>
              </div>
            </div>
          </div>
